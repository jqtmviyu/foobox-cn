...
function init_buttons() {
	...
	buttons[4] = new ButtonUI(img_playlist, "播放列表");
	buttons[5] = new ButtonUI(img_artist, "艺术家");
	buttons[6] = new ButtonUI(img_album, "专辑");
	buttons[7] = new ButtonUI(img_genre, "流派 | 目录");
	buttons[8] = new ButtonUI(img_settings, "设置");
	buttons[9] = new ButtonUI(img_lrc, "歌曲信息");
	if(show_libtree) buttons[10] = new ButtonUI(img_lib, "媒体库");
	else buttons[10] = new ButtonUI(img_lib_2, "列表视图");
	if(show_vis) buttons[11] = new ButtonUI(img_shp, "可视化");
	if(show_mpv) buttons[11 + show_vis] = new ButtonUI(img_mpv, "视频");
...
function update_libBtn(){
	if(show_libtree){
		...
		buttons[10].Tooltip.Text = "媒体库";
	} else{
		buttons[10].img = img_lib_2;
		buttons[10].Tooltip.Text = "列表视图";
	}
...
function init_icons() {
	...
	try {
		...
		gb.SetSmoothingMode(0);
		gb.DrawRect(_x8, _x11, _x7, _x7, 2, c_normal);
		gb.DrawLine(_x10, _x9-1, _x18+1, _x9-1, 2, c_normal);
		gb.DrawLine(_x18, _x9-1, _x18, _x16, 2, c_normal);
		gb.DrawLine(_x10+1, _x9-1, _x10+1, _x11, 2, c_normal);
		gb.DrawLine(_x16-1, _x16-1, _x18, _x16-1, 2, c_normal);
		gb.SetSmoothingMode(2);
		gb.FillEllipse(1, _imgh + 1, _imgh - 2, _imgh - 2, c_shadow_h);
		gb.SetSmoothingMode(0);
		gb.DrawRect(_x8, _x11+_imgh, _x7, _x7, 2, c_hover);
		gb.DrawLine(_x10, _x9-1+_imgh, _x18+1, _x9-1+_imgh, 2, c_hover);
		gb.DrawLine(_x18, _x9-1+_imgh, _x18, _x16+_imgh, 2, c_hover);
		gb.DrawLine(_x10+1, _x9-1+_imgh, _x10+1, _x11+_imgh, 2, c_hover);
		gb.DrawLine(_x16-1, _x16-1+_imgh, _x18, _x16-1+_imgh, 2, c_hover);
		gb.SetSmoothingMode(2);
		gb.FillEllipse(1, imgh2 + 1, _imgh - 2, _imgh - 2, c_shadow);
		gb.SetSmoothingMode(0);
		gb.DrawRect(_x8, _x11+imgh2, _x7, _x7, 2, c_down);
		gb.DrawLine(_x10, _x9-1+imgh2, _x18+1, _x9-1+imgh2, 2, c_down);
		gb.DrawLine(_x18, _x9-1+imgh2, _x18, _x16+imgh2, 2, c_down);
		gb.DrawLine(_x10+1, _x9-1+imgh2, _x10+1, _x11+imgh2, 2, c_down);
		gb.DrawLine(_x16-1, _x16-1+imgh2, _x18, _x16-1+imgh2, 2, c_down);
