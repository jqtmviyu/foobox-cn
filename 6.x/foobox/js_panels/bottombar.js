...
function initbuttons(){
	PlaybackTimeText = new UITextView(track_time, g_font, fontcolor, DT_CALCRECT | DT_VCENTER | DT_RIGHT);
	PlaybackLengthText = new UITextView((track_len ? track_len : "00:00:00"), g_font, fontcolor, DT_CALCRECT | DT_VCENTER | DT_LEFT);
...
function init_obj() {
	...
	PlaybackTimeText.SetSize(btn_end_x+btn_space, 0, time_length, wh);
	PlaybackLengthText.SetSize(time_len_x, 0, time_length, wh);
